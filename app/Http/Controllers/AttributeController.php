		...
		{ 
				...
				foreach($data['language_code'] as $index => $code)
				{
				   ...
				   $attributevalue = $attribute_value[$index];
					...
					$record = array('attribute_id' => $attribute_type, 'user_id' => $user_id, 'attribute_value' => $attributevalue, 'attribute_value_slug' => $attribute_value_slug, 'attribute_value_status' => $attribute_status, 'token' => $token, 'language_code' => $code, 'attrivalue_page_parent' => $parent);
		   ...
		   if($code=="en")
			{
              ...
              $data = array('attribute_id' => $attribute_type, 'attribute_value' => $attributevalue, 'attribute_value_slug' => $attribute_value_slug, 'attribute_value_status' => $attribute_status, 'language_code' => $code);
			    ...
			    if($counts==0)
				 {
					 ...
					 $save = array('attribute_id' => $attribute_type, 'user_id' => $user_id,  'attribute_value' => $attrivalue, 'attribute_value_slug' => $attribute_value_slug, 'attribute_value_status' => $attribute_status, 'language_code' => $code, 'token' => $token, 'attrivalue_page_parent' => $attribute_value_id);
				 ...
				 else
				 {
				   ...
				   $updata = array('attribute_id' => $attribute_type, 'attribute_value' => $attributevalue, 'attribute_value_slug' => $attribute_value_slug, 'attribute_value_status' => $attribute_status);
