...
class CommonController extends Controller
{
    ...
    public function view_index()
	{
	   ...
	   $data = array('setting' => $setting, 'slideshow' => $slideshow, 'physical' => $physical, 'external' => $external, 'digital' => $digital, 'deal' => $deal, 'brand' => $brand,'shop' =>$shop);
	...
	public function view_category_shop($type,$slug)
	{
	   ...
	   $attributer['display'] = Attribute::with('AttributeValue')->where('attribute_status','=','1')->where('attribute_drop_status','=','no')->where('attribute_search','=',1)->where('language_code','=',$translate)->orderBy('attribute_order','asc')->get();
