...
class Attribute extends Model
{
  ...
  public static function getLastAttriId($data){
    ...
    $value=DB::table('product_attribute_value')->join('product_attribute','product_attribute.attribute_id','product_attribute_value.attribute_id')->where('product_attribute_value.attrivalue_page_parent','=',0)->where('product_attribute_value.attribute_value_drop_status','=','no')->select(DB::raw('product_attribute.*, product_attribute_value.*,product_attribute_value.user_id as user_user_id'))->orderBy('product_attribute_value.attribute_value_id', 'desc')->get(); 
    return $value;
