                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="site_admin_commission" name="site_admin_commission" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->site_admin_commission }}" data-bvalidator="required,digit,min[1]"><small>({{ Helper::translation(3636,$translate) }})</small>
                                            </div>
                                           <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(1993,$translate) }}</label>
                                                <input id="site_processing_fee" name="site_processing_fee" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->site_processing_fee }}" data-bvalidator="min[1]"><small>({{ Helper::translation(3639,$translate) }})</small>
                                            </div>
                                            <div class="form-group">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="payment_option" name="payment_option[]" type="checkbox" @if(in_array($payment,$get_payment)) checked @endif class="noscroll_textarea" value="{{ $payment }}"> {{ str_replace("-"," ",$payment) }} @if($payment == 'paystack') (NGN - {{ Helper::translation(3663,$translate) }}) @endif<br/>@endforeach</div>
                                    </div>
                                </div>
                              </div>
                            </div>
                           ...
                           <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(2129,$translate) }} <span class="require">*</span></label><br/>
