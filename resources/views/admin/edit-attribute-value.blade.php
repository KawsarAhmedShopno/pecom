            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(2020,$translate) }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade @if($i == 1) show active @endif mt-4" id="{{ $language->language_name }}" role="tabpanel">
              <div class="form-group">
                   ...
                   <input type="text" name="attribute_value[]" id="attribute_value" value="@if(!empty($view->attribute_value)){{ $view->attribute_value }}@endif"   class="form-control" data-bvalidator="required">
              </div>
      ...
      <div class="form-group">
                   <label for="name" class="control-label mb-1">{{ Helper::translation(2982,$translate) }} <span class="require">*</span></label>
                                       ...
                                       <div class="form-group">
                                            ...
                                            <input type="hidden" name="user_id" value="{{ $edit['value']->user_id }}">
                                    </div>
                                </div>
                              </div>
                            </div>
