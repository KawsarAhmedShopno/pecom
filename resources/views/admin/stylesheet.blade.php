...
@endif
<link rel="stylesheet" href="{{ URL::to('public/admin/template/vendors/bootstrap/dist/css/bootstrap.min.css') }}">
<link rel="stylesheet" href="{{ URL::to('public/admin/template/vendors/font-awesome/css/font-awesome.min.css') }}">
<link rel="stylesheet" href="{{ URL::to('public/admin/template/vendors/themify-icons/css/themify-icons.css') }}">
<link rel="stylesheet" href="{{ URL::to('public/admin/template/vendors/flag-icon-css/css/flag-icon.min.css') }}">
<link rel="stylesheet" href="{{ URL::to('public/admin/template/vendors/selectFX/css/cs-skin-elastic.css') }}">
<link rel="stylesheet" href="{{ URL::to('public/admin/template/vendors/jqvmap/dist/jqvmap.min.css') }}">
...
<link rel="stylesheet" href="{{ URL::to('public/admin/template/assets/css/style.css') }}">
