                      ...
                      <div class="row">
                        ...
                        <div 
						   ...
						   data-control-name="themes">
                            ...
                            @endphp
                            <input type="checkbox" name="category[]" value="cat-{{ $menu_cat }}" data-path=".cat-{{ $menu_cat }}" id="cat-{{ $menu_cat }}"> {{ $menu->category_name }}<br/>
                               @if(count($menu->subcategory) != 0)
                                  ...
                                  @php if($translate == 'en'){ $menu_subcat = $sub_category->subcat_id; } else { $menu_subcat = $sub_category->subcategory_page_parent; } @endphp
                                   <span class="move_subcategory"><input type="checkbox" name="category[]" value="subcat-{{ $menu_subcat }}" data-path=".subcat-{{ $menu_subcat }}" id="subcat-{{ $menu_subcat }}"> {{ $sub_category->subcategory_name }}<br/></span>
                                  @endforeach
                               @endif
                            @endforeach
                            </div>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        @php if($translate == 'en') { $value_id = $product_value->attribute_value_id; } else { $value_id = $product_value->attrivalue_page_parent; } @endphp
                            <input type="checkbox" name="attribute[]" value="{{ $value_id }}" data-path=".{{ $value_id }}" id="{{ $value_id }}"> {{ $product_value->attribute_value }}<br/>
                        @endforeach 
                        </div>   
                        </div>
                      </div>
