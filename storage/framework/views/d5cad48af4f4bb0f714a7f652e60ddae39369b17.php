    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(3096,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                ...
                <div class="row">
                   <div class="col-md-12">
                       <?php if($demo_mode == 'on'): ?>
                           ...
                           <?php else: ?>
                       <form action="<?php echo e(route('admin.add-subcategory')); ?>" method="post" id="category_form" enctype="multipart/form-data">
        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade <?php if($i == 1): ?> show active <?php endif; ?> mt-4" id="<?php echo e($language->language_name); ?>" role="tabpanel">
              <div class="form-group">
                   <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(3099,$translate)); ?> <span class="require">*</span></label>
                   <input type="text" name="subcategory_name[]" id="subcategory_name" value=""   class="form-control" data-bvalidator="required">
              </div>
      ...
      <div class="form-group">
                   <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(2982,$translate)); ?> <span class="require">*</span></label>
                                                <input id="subcategory_slug" name="subcategory_slug" type="text" class="form-control" data-bvalidator="required">
                                            </div>
                                       <div class="form-group">
                                                <label for="cat_id" class="control-label mb-1"><?php echo e(Helper::translation(3045,$translate)); ?> <span class="require">*</span></label>
...
</html><?php /**PATH /home/parifqis/public_html/resources/views/admin/add-subcategory.blade.php ENDPATH**/ ?>