            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(2149,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <br/><?php $__currentLoopData = $editimage['view']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                 <div class="item-img"><img src="<?php echo e(url('/')); ?>/public/storage/product/<?php echo e($product->product_image); ?>" alt="<?php echo e($product->product_image); ?>" class="item-thumb">
                                                    <a href="<?php echo e(url('/admin/edit-product')); ?>/dropimg/<?php echo e(base64_encode($product->proimg_id)); ?>" onClick="return confirm('<?php echo e(Helper::translation(1968,$translate)); ?>');" class="drop-icon"><span class="ti-trash drop-icon"></span></a>
                                                    </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <?php if($allsettings->type_of_marketplace == 'multi-vendor'): ?>
                                      <div class="form-group">
                                         ...
                                         <div class="form-group">
                                             ...
                                             <textarea name="product_tags" id="product_tags" rows="4" placeholder="separate tag with commas" class="form-control noscroll_textarea"><?php echo e($edit['product']->product_tags); ?></textarea></div>                      <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['product']->product_featured == 1): ?> selected <?php endif; ?>><?php echo e(Helper::translation(1942,$translate)); ?></option>
                                                <option value="0" <?php if($edit['product']->product_featured == 0): ?> selected <?php endif; ?>><?php echo e(Helper::translation(1943,$translate)); ?></option>
                                                </select>
                                            </div>
                                         <div class="form-group">
                                     ...
                                     <div class="form-group">
                                           ...
                                           <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(1947,$translate)); ?></label>
                                     ...
                                     <div class="form-group">
                                                ...
                                                <input id="product_local_shipping_fee" name="product_local_shipping_fee" type="text" class="form-control" data-bvalidator="min[0]" value="<?php echo e($edit['product']->product_local_shipping_fee); ?>"><small>(<?php echo e(Helper::translation(3063,$translate)); ?>) <span class="red-color"> - <?php echo e(Helper::translation(1959,$translate)); ?></span></small>
                                     </div> 
                                     <div class="form-group">
                                                ...
                                                <input id="product_global_shipping_fee" name="product_global_shipping_fee" type="text" class="form-control" data-bvalidator="min[0]" value="<?php echo e($edit['product']->product_global_shipping_fee); ?>"><small>(<?php echo e(Helper::translation(3066,$translate)); ?>) <span class="red-color"> - <?php echo e(Helper::translation(1959,$translate)); ?></span></small>
                                     </div>
                                    </div>
                                    <div class="form-group">
                                  ...
                                  <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['product']->product_status == 1): ?> selected <?php endif; ?>><?php echo e(Helper::translation(1916,$translate)); ?></option>
                                                <option value="0" <?php if($edit['product']->product_status == 0): ?> selected <?php endif; ?>><?php echo e(Helper::translation(1917,$translate)); ?></option>
                                                </select>
                                   </div>
...
</html><?php /**PATH /home/parifqis/public_html/resources/views/admin/edit-product.blade.php ENDPATH**/ ?>