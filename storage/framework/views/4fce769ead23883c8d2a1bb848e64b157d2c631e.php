            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(3255,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                         ...
                         <div class="col-md-8">
                           <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                      ...
                                      <div class="tab-pane fade <?php if($i == 1): ?> show active <?php endif; ?> mt-4" id="<?php echo e($language->language_name); ?>" role="tabpanel">
                                          <div class="form-group">
                                               <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(3072,$translate)); ?></label>
                                          ...
                                          <div class="form-group">
                                              <label for="site_desc" class="control-label mb-1"><?php echo e(Helper::translation(3075,$translate)); ?></label>
                                          ...
                                          <div class="form-group">
                                              <label for="site_desc" class="control-label mb-1"><?php echo e(Helper::translation(3078,$translate)); ?></label>
                                  ...
                                  <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"> <?php echo e(Helper::translation(3081,$translate)); ?></label>
                                                <select name="slide_text_position" class="form-control">
                                                <option value="left" <?php if($edit['slide']->slide_text_position == 'left'): ?> selected <?php endif; ?>><?php echo e(Helper::translation(3084,$translate)); ?></option>
                                                <option value="right" <?php if($edit['slide']->slide_text_position == 'right'): ?> selected <?php endif; ?>><?php echo e(Helper::translation(3087,$translate)); ?></option>
                                                <option value="center" <?php if($edit['slide']->slide_text_position == 'center'): ?> selected <?php endif; ?>><?php echo e(Helper::translation(3090,$translate)); ?></option>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label for="site_logo" class="control-label mb-1"><?php echo e(Helper::translation(3579,$translate)); ?> <?php echo e(Helper::translation(2099,$translate)); ?> (<?php echo e(Helper::translation(3003,$translate)); ?> 1920 x 400) <span class="require">*</span></label>
                                            <input type="file" id="slide_image" name="slide_image" class="form-control-file"  <?php if($edit['slide']->slide_image == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="<?php echo e(Helper::translation(1937,$translate)); ?>" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>><?php if($edit['slide']->slide_image != ''): ?> <img  src="<?php echo e(url('/')); ?>/public/storage/slideshow/<?php echo e($edit['slide']->slide_image); ?>" alt="<?php echo e($edit['slide']->slide_image); ?>" class="image-size" /><?php else: ?> <img src="<?php echo e(url('/')); ?>/public/img/no-image.jpg" alt="<?php echo e($edit['slide']->slide_image); ?>"  class="image-size"/>  <?php endif; ?>
                                            </div>                                  
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(3093,$translate)); ?></label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <option value=""></option>
                                                <option value="1" <?php if($edit['slide']->slide_status == 1): ?> selected <?php endif; ?>><?php echo e(Helper::translation(1916,$translate)); ?></option>
                                                <option value="0" <?php if($edit['slide']->slide_status == 0): ?> selected <?php endif; ?>><?php echo e(Helper::translation(1917,$translate)); ?></option>
                                                </select>
                                             </div>   
...
</html><?php /**PATH C:\xampp\htdocs\par\resources\views/admin/edit-slideshow.blade.php ENDPATH**/ ?>