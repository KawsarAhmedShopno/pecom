                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="<?php echo e(url('/admin/edit-profile')); ?>"><i class="fa fa-user"></i> <?php echo e(Helper::translation(2043,$translate)); ?></a>
                            <?php if(in_array('settings',$avilable)): ?> 
                            <a class="nav-link" href="<?php echo e(url('/admin/general-settings')); ?>"><i class="fa fa-cog"></i> <?php echo e(Helper::translation(3408,$translate)); ?></a>
                            <?php endif; ?>
                            <a class="nav-link" href="<?php echo e(url('/logout')); ?>"><i class="fa fa-power-off"></i> <?php echo e(Helper::translation(2048,$translate)); ?></a>
                        </div>
                  </div>
...
</header>           <?php /**PATH /home/parifqis/public_html/resources/views/admin/header.blade.php ENDPATH**/ ?>