...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <main role="main" class="main-content">
     ...
     <?php if(count($deal['product']) != 0): ?> 
      ...
      <!-- all category -->
      <?php $__currentLoopData = $categories['display']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="container pt-3 mt-3 pb-3 mb-3">
          <div class="row">
          <h4 class="black mb-2 pb-2"><?php echo e($category->category_name); ?></h4>
          <div class="swiper-container"> 
                            <div class="swiper-wrapper">  
                            <?php $z = 1; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\par\resources\views/index.blade.php ENDPATH**/ ?>