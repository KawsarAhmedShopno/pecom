                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="site_banner_one_heading" name="site_banner_one_heading" type="text" class="form-control noscroll_textarea" value="<?php echo e(Helper::translation(2943,'en')); ?>" readonly><a href="languages" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; Translate</a></div><div class="form-group">
                                    ...
                                    <div class="card-body">
                                     <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="site_banner_two_heading" name="site_banner_two_heading" type="text" class="form-control noscroll_textarea" value="<?php echo e(Helper::translation(2946,'en')); ?>" readonly><a href="languages" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; Translate</a></div><div class="form-group">
                                    ...
                                    <div class="card-body">
                                      ...
                                      <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="site_banner_three_heading" name="site_banner_three_heading" type="text" class="form-control noscroll_textarea" value="<?php echo e(Helper::translation(2949,'en')); ?>" readonly><a href="languages" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; Translate</a></div><div class="form-group">
