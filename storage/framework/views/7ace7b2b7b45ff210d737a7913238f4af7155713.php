                       ...
                       <div class="card">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="site_admin_commission" name="site_admin_commission" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->site_admin_commission); ?>" data-bvalidator="required,digit,min[1]"><small>(<?php echo e(Helper::translation(3636,$translate)); ?>)</small>
                                            </div>
                                           <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(1993,$translate)); ?></label>
                                                <input id="site_processing_fee" name="site_processing_fee" type="text" class="form-control noscroll_textarea" value="<?php echo e($setting['setting']->site_processing_fee); ?>" data-bvalidator="min[1]"><small>(<?php echo e(Helper::translation(3639,$translate)); ?>)</small>
                                            </div>
                                            <div class="form-group">
                         ...
                         <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                ...
                                                <input id="payment_option" name="payment_option[]" type="checkbox" <?php if(in_array($payment,$get_payment)): ?> checked <?php endif; ?> class="noscroll_textarea" value="<?php echo e($payment); ?>"> <?php echo e(str_replace("-"," ",$payment)); ?> <?php if($payment == 'paystack'): ?> (NGN - <?php echo e(Helper::translation(3663,$translate)); ?>) <?php endif; ?><br/><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div>
                                    </div>
                                </div>
                              </div>
                            </div>
                           ...
                           <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                <label for="site_title" class="control-label mb-1"><?php echo e(Helper::translation(2129,$translate)); ?> <span class="require">*</span></label><br/>
                           ...
                           <div class="card-body">
                            ...
                            <div class="col-md-12"><div class="card-body"><h4><?php echo e(Helper::translation(3693,$translate)); ?></h4></div></div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12"><div class="card-body"><h4><?php echo e(Helper::translation(3708,$translate)); ?></h4></div></div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12"><div class="card-body"><h4><?php echo e(Helper::translation(3720,$translate)); ?></h4></div></div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12"><div class="card-body"><h4><?php echo e(Helper::translation(3732,$translate)); ?></h4></div></div>
                            <div class="col-md-6">
...
</html><?php /**PATH /home/parifqis/public_html/resources/views/admin/payment-settings.blade.php ENDPATH**/ ?>