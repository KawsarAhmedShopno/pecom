             ...
             <ul class="countdown-<?php echo e($shop->product_token); ?>" id="countdown-timer">
                                         ...
                                         <?php if($shop->product_type != 'digital'): ?>
                                           <span>
                                              ...
                                              <input type="number" name="qty" class="form-control qty_box" min="1" data-bvalidator="required,min[1],max[<?php echo e($shop->product_stock); ?>]" value="1">
                                           </span>
                                          <?php else: ?>
...
<?php endif; ?><?php /**PATH /home/parifqis/public_html/resources/views/product.blade.php ENDPATH**/ ?>