                      ...
                      <div class="row">
                        ...
                        <div 
						   ...
						   data-control-name="themes">
                            ...
                            ?>
                            <input type="checkbox" name="category[]" value="cat-<?php echo e($menu_cat); ?>" data-path=".cat-<?php echo e($menu_cat); ?>" id="cat-<?php echo e($menu_cat); ?>"> <?php echo e($menu->category_name); ?><br/>
                               <?php if(count($menu->subcategory) != 0): ?>
                                  ...
                                  <?php if($translate == 'en'){ $menu_subcat = $sub_category->subcat_id; } else { $menu_subcat = $sub_category->subcategory_page_parent; } ?>
                                   <span class="move_subcategory"><input type="checkbox" name="category[]" value="subcat-<?php echo e($menu_subcat); ?>" data-path=".subcat-<?php echo e($menu_subcat); ?>" id="subcat-<?php echo e($menu_subcat); ?>"> <?php echo e($sub_category->subcategory_name); ?><br/></span>
                    ...
                    <div class="card-body">
                      <div class="row">
                        ...
                        <?php if($translate == 'en') { $value_id = $product_value->attribute_value_id; } else { $value_id = $product_value->attrivalue_page_parent; } ?>
                            <input type="checkbox" name="attribute[]" value="<?php echo e($value_id); ?>" data-path=".<?php echo e($value_id); ?>" id="<?php echo e($value_id); ?>"> <?php echo e($product_value->attribute_value); ?><br/>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                        </div>   
                        </div>
                      </div>
...
<?php endif; ?><?php /**PATH /home/parifqis/public_html/resources/views/shop.blade.php ENDPATH**/ ?>