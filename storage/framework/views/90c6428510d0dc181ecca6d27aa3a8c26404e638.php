                                       ...
                                       <div class="form-group">
                                            ...
                                            <input type="file" id="site_header_background" name="site_header_background" class="form-control-file" <?php if($setting['setting']->site_header_background == ''): ?> data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php else: ?> data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" <?php endif; ?>><?php if($setting['setting']->site_header_background != ''): ?>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input id="site_copyright" name="site_copyright" type="text" class="form-control noscroll_textarea" value="<?php echo e(Helper::translation(2958,'en')); ?>" data-bvalidator="required" readonly><a href="languages" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; Translate</a>
                                            </div>  
                                            ...
                                            <div class="form-group">
                                             ...
                                             <textarea name="cookie_popup_text" id="cookie_popup_text" rows="5" class="form-control noscroll_textarea" data-bvalidator="required" readonly><?php echo e(Helper::translation(2952,'en')); ?></textarea><a href="languages" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; Translate</a>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                  ...
                                  <div class="form-group">
                                                ...
                                                <input id="cookie_popup_button" name="cookie_popup_button" type="text" class="form-control noscroll_textarea" value="<?php echo e(Helper::translation(2955,'en')); ?>" data-bvalidator="required" readonly><a href="languages" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp; Translate</a>
                                 </div>
                                 <div class="form-group">
