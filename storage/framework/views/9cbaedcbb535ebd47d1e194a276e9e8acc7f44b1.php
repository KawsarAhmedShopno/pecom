            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1><?php echo e(Helper::translation(2991,$translate)); ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                       <div class="form-group">
                                                <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(2994,$translate)); ?> <span class="require">*</span></label>
                                                <input id="brand_name" name="brand_name" type="text" class="form-control" data-bvalidator="required">
                                            </div> 
                                            <div class="form-group">
                                                <label for="site_logo" class="control-label mb-1"><?php echo e(Helper::translation(2099,$translate)); ?> (<?php echo e(Helper::translation(3003,$translate)); ?> 200 x 200)</label>
                                                ...
                                                <label for="name" class="control-label mb-1"><?php echo e(Helper::translation(3447,$translate)); ?></label>
...
</html><?php /**PATH /home/parifqis/public_html/resources/views/admin/add-brand.blade.php ENDPATH**/ ?>